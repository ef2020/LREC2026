# TODO.md — LREC2026 Task Tracker

> **Camera-ready deadline: March 6, 2026**
> **Conversions & comments due: February 27, 2026**

---

## 🔴 High Priority — Due Feb 27
...
## 🟡 Medium Priority — Due Mar 6

### Corpus Packaging (Neh)
- [ ] Collect all conversion files from Anne, Frank, Elena
- [ ] Apply shuffling/randomization procedure to all Match-Up puzzles
- [ ] Convert all puzzles to unified format
- [ ] Create GitHub folder structure for the corpus
...
### Documentation
- [ ] Populate `docs/conversion_guide.md` with detailed examples from the examples file
- [ ] Add links to individual puzzle sources in `LREC_missing_puzzles`
- [ ] Create summary table of all conversions (converted vs. skipped, with reasons)

### Repository Maintenance
- [ ] Set up `.gitignore` for any binary/temp files
- [ ] Ensure all Google Drive reference materials are linked or mirrored
